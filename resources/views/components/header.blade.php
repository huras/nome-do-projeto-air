@php
    $navbarTheme = trim($__env->yieldContent('navbar-theme', 'navbar-dark bg-dark'));
    $svg_fill_color = 'white';
    if($navbarTheme == 'navbar-light bg-white') {
        $svg_fill_color = 'black';
    }
@endphp


<nav class="navbar {{ $navbarTheme ?? 'navbar-dark bg-dark' }} sticky-top z-3" aria-label="air">
        ...
        <a class="navbar-brand" href="/">
            <svg width="77" height="45" viewBox="0 0 77 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    ...
                    fill="{{$svg_fill_color}}" />
                <path d="M51.4548 11.3668H44.5513V43.9577H51.4548V11.3668Z" fill="{{$svg_fill_color}}" />
                <path d="M51.4548 0H44.5513V7.14895H51.4548V0Z" fill="{{$svg_fill_color}}" />
                <path
